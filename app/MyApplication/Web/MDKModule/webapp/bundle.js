...
let myapplication_actions_products_navtoproducts_detail_action = __webpack_require__(/*! ./MyApplication/Actions/Products/NavToProducts_Detail.action */ "./build.definitions/MyApplication/Actions/Products/NavToProducts_Detail.action")
let myapplication_actions_products_navtoproducts_list_action = __webpack_require__(/*! ./MyApplication/Actions/Products/NavToProducts_List.action */ "./build.definitions/MyApplication/Actions/Products/NavToProducts_List.action")
...
let myapplication_pages_products_products_detail_page = __webpack_require__(/*! ./MyApplication/Pages/Products/Products_Detail.page */ "./build.definitions/MyApplication/Pages/Products/Products_Detail.page")
let myapplication_pages_products_products_list_page = __webpack_require__(/*! ./MyApplication/Pages/Products/Products_List.page */ "./build.definitions/MyApplication/Pages/Products/Products_List.page")
...
module.exports = {
	...
	myapplication_actions_products_navtoproducts_detail_action : myapplication_actions_products_navtoproducts_detail_action,
	myapplication_actions_products_navtoproducts_list_action : myapplication_actions_products_navtoproducts_list_action,
	...
	myapplication_pages_products_products_detail_page : myapplication_pages_products_products_detail_page,
	myapplication_pages_products_products_list_page : myapplication_pages_products_products_list_page,
...
/***/ "./build.definitions/MyApplication/Pages/Products/Products_Detail.page":
/*!*****************************************************************************!*\
  !*** ./build.definitions/MyApplication/Pages/Products/Products_Detail.page ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = {"Caption":"Products Detail","DesignTimeTarget":{"Service":"/MyApplication/Services/service1.service","EntitySet":"Products","QueryOptions":""},"ActionBar":{"Items":[]},"Controls":[{"Sections":[{"ObjectHeader":{"Tags":[],"DetailImage":"","HeadlineText":"{Name}","Subhead":"","BodyText":"","Footnote":"","Description":"","StatusText":"","StatusImage":"","SubstatusImage":"","SubstatusText":""},"_Type":"Section.Type.ObjectHeader"},{"KeyAndValues":[{"KeyName":"Name","Value":"{Name}"}],"Layout":{"NumberOfColumns":2},"MaxItemCount":1,"_Name":"SectionKeyValue0","_Type":"Section.Type.KeyValue"}],"DataSubscriptions":[],"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Products_Detail","PrefersLargeCaption":true}

/***/ }),

/***/ "./build.definitions/MyApplication/Pages/Products/Products_List.page":
/*!***************************************************************************!*\
  !*** ./build.definitions/MyApplication/Pages/Products/Products_List.page ***!
  \***************************************************************************/
/***/ ((module) => {

module.exports = {"Caption":"Products","ActionBar":{"Items":[]},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false},"ObjectCell":{"AccessoryType":"disclosureIndicator","Description":"","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/MyApplication/Actions/Products/NavToProducts_Detail.action","StatusImage":"","Title":"{Name}","Footnote":"","PreserveIconStackSpacing":false,"StatusText":"","Subhead":"","SubstatusText":""},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Products","Service":"/MyApplication/Services/service1.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","ToolBar":{"Items":[{"_Name":"LogoutToolbarItem","_Type":"Control.Type.ToolbarItem","Caption":"Logout","OnPress":"/MyApplication/Actions/Logout.action"}]},"_Name":"Products_List","PrefersLargeCaption":true}
...
module.exports = {"_Name":"MyApplication","Version":"/MyApplication/Globals/AppDefinition_Version.global","MainPage":"/MyApplication/Pages/Products/Products_List.page","OnLaunch":["/MyApplication/Actions/Service/InitializeOnline.action"],"OnWillUpdate":"/MyApplication/Rules/OnWillUpdate.js","OnDidUpdate":"/MyApplication/Actions/Service/InitializeOnline.action","Styles":"/MyApplication/Styles/Styles.less","Localization":"/MyApplication/i18n/i18n.properties","_SchemaVersion":"6.3","StyleSheets":{"Styles":{"css":"/MyApplication/Styles/Styles.css","ios":"/MyApplication/Styles/Styles.nss","android":"/MyApplication/Styles/Styles.json"}}}
...
/***/ "./build.definitions/MyApplication/Actions/Products/NavToProducts_Detail.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/MyApplication/Actions/Products/NavToProducts_Detail.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/MyApplication/Pages/Products/Products_Detail.page"}

/***/ }),

/***/ "./build.definitions/MyApplication/Actions/Products/NavToProducts_List.action":
/*!************************************************************************************!*\
  !*** ./build.definitions/MyApplication/Actions/Products/NavToProducts_List.action ***!
  \************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/MyApplication/Pages/Products/Products_List.page"}
...
module.exports = {"DestinationName":"../service/MingTest1/","OfflineEnabled":false,"LanguageURLParam":"","OnlineOptions":{},"PathSuffix":"","SourceType":"Cloud","ServiceUrl":""}
